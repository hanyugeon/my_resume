export const dadokArticle = {
  ...
  contents: {
    contributions: [
      {
        title: "점진적 Next.js App router 마이그레이션 진행",
    ...
    learned: [
      "Next.js로 개발 및 App router 마이그레이션을 진행하며 RSC에 대해 알 수 있었고 SSR, SEO, middleware 등을 경험했습니다.",
      "기존 UI의 문제 발견, 원인 정의를 통해 프로젝트 리디자인, Funnel 도입, 검색 결과 유지 기능 구현 등의 작업을 통해 UI/UX 개선 능력을 길렀습니다.",
      "Storybook을 활용한 UI 테스트를 통해 컴포넌트 주도 개발(CDD)을 진행하며 독립적이고 안전한 컴포넌트를 작성할 수 있었습니다.",
      "github-actions 워크플로 작성을 통해 자동화를 경험하며 DX(개발자 경험) 또한 중요한 요소라는 것을 알게됐습니다.",
      "자체 이미지 최적화 구현을 통해, 최소 비용 최대 성능을 끌어내는 작업을 경험했습니다.",
    ],
  },
};
