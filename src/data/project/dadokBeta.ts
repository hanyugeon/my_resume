export const dadokBetaArticle = {
  ...
  contents: {
    ...
    learned: {
      "1": "Canvas 활용으로 인한 CORS 에러를 경험하며 CORS 정책에 대해 이해할 수 있었습니다.",
      "2": "무한 스크롤, 낙관적 UI 업데이트 적용 작업을 통해 여러 방법으로 긍정적인 사용자 경험을 끌어낼 수 있따는 것을 알게 됐습니다.",
      "3": "코어 타임, 피어 리뷰, 실내 스포츠 타임 등 건전한 개발 문화를 조성하며 짧은 개발 기간동안 협업에 필요한 소프트스킬을 높일 수 있었습니다.",
    },
  },
};
